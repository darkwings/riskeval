...
The scores are then passed to the final evaluator agent `risk_evaluator`. This agent will check the scores and then perform a final evaluation, giving back a global score.